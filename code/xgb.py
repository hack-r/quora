...
print("Import raw training data set...")
df_train = pd.read_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//train.csv')
...
print('Importing and building Test Features')
df_test = pd.read_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//test_features.csv', encoding="ISO-8859-1")
...
sub.to_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//sub_minimal_test_set.csv')
print("DONE!!")
...
x_test.to_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_test_ds.csv")
X_train.to_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_train_ds.csv")
X_valid.to_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_valid_ds.csv")

np.savetxt("T:/RNA/Baltimore/Jason/ad_hoc/quora/data/y_train.csv", y_train, delimiter=",")
np.savetxt("T:/RNA/Baltimore/Jason/ad_hoc/quora/data/y_valid.csv", y_valid, delimiter=",")
