...
argssave = "xgb_py_absh_v2"

# print("Import training data set / features...")
# df_train = pd.read_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//train_features.csv', encoding="ISO-8859-1")
...
#
# print("Import R-enhanced training data set...")
# df_train = pd.read_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//train2.csv')
# df_train = df_train.fillna(' ')
#
# print("Import test data set...")
# df_test = pd.read_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//test.csv')
# print("Process test and train data sets...")
...
#
# X_train, X_valid, y_train, y_valid = train_test_split(X_train, y_train, test_size=0.01, random_state=4242)
#
# print("Write out finalized training and validation data sets for R")
# X_valid.to_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_valid_ds2.csv")
# X_train.to_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_train_ds2.csv")
# np.savetxt("T:/RNA/Baltimore/Jason/ad_hoc/quora/data/y_train2.csv", y_train, delimiter=",")
# np.savetxt("T:/RNA/Baltimore/Jason/ad_hoc/quora/data/y_valid2.csv", y_valid, delimiter=",")

# UPDownSampling
X_train = pd.read_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_train2.csv")
X_valid = pd.read_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_valid2.csv")
...
bst.save_model(argssave + '.mdl')

print('Importing pre-compiled Test DS from R')
x_test = pd.read_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//x_test2.csv') #, encoding="ISO-8859-1"
...
df_test = pd.read_csv("T://RNA//Baltimore//Jason//ad_hoc//quora//data//sample_submission.csv")
...
sub.to_csv('T://RNA//Baltimore//Jason//ad_hoc//quora//data//py_xgb_new_feats.csv')
print("DONE!!")
